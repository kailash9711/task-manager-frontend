      ...
      <div className='flex flex-col gap-8'>
        ...
        <form onSubmit={handleLogin} className='flex flex-col gap-5'>
          ...
          <div className="flex justify-end pt-1">
            <button type='button' className='text-xs text-slate-500 transition-colors hover:text-slate-900 dark:text-slate-400 dark:hover:text-slate-100'>
              Forgot password?
            </button>
          </div>
          ...
          <button
            ...
            className='mt-2 flex w-full items-center justify-center gap-2 rounded-full bg-slate-900 px-4 py-3.5 text-sm font-medium text-white transition-all hover:scale-[1.02] active:scale-[0.98] disabled:opacity-50 disabled:hover:scale-100 dark:bg-white dark:text-slate-900'
          >
            {isSubmitting ? (
